...
Revision 1.02 - Added Log Comment  2003/03/24 19:37:42  ckeith
	...
	<xsl:template name="marcRecord">
		...
		<xsl:for-each select="marc:datafield[@tag='072']">
			<xsl:call-template name="createSubjectTopicAndClassificationFrom072"/>
		</xsl:for-each>
		...
		<xsl:for-each select="marc:datafield[@tag='247']">
			<xsl:call-template name="createFormerTitleFrom247"/>
		</xsl:for-each>
...
-->
	...
	<xsl:template name="createClassificationFrom080">
		<classification authority="udc">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="createEditionAttribute080"/>
			<xsl:call-template name="subfieldSelect">
	...
	<xsl:template name="createSubjectTopicAndClassificationFrom072">
		<subject>
			<xsl:if test="marc:subfield[@code='2']">
				<xsl:attribute name="authority">
					<xsl:value-of select="marc:subfield[@code='2']"/>
	...
	<xsl:template name="createEditionAttribute080">
		<xsl:if test="marc:subfield[@code='2']">
			<xsl:attribute name="edition">
				<xsl:value-of select="marc:subfield[@code='2']"/>
			</xsl:attribute>
	...
	<xsl:template name="createFormerTitleFrom247">
		<titleInfo type="alternative" displayLabel="former title">
			<title>
				<xsl:value-of select="marc:subfield[@code='a']"/>
			</title>
		</titleInfo>
